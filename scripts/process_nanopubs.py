...
def run_content_generation(configs):
    ...
    try:
        ...
        print("✅ Initialized content generator")
    except Exception as e:
        print(f"❌ Failed to initialize content generator: {e}")
        return []
...
def main():
    ...
    print(f"📦 Method: Python package (nanopub-content-generator)")
    ...
    if enable_content_generation:
        print("\n🚀 Starting package-based content generation...")
...
✅ Package-Based Integration: Clean import and function calls
✅ No Repository Cloning: Direct Python package installation
✅ Better Dependency Management: pip handles everything
...
"""
    ...
    if success_count > 0:
        ...
        print("=== ❌ PACKAGE-BASED ORCHESTRATION FAILED ===")
